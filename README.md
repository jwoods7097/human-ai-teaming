...
#### Example usage:
```bash
python trail_to_pkl.py /overcookedgym/overcooked-flask/data/user_study/
```
---
...
#### **Example usage:**  
```bash
python rl_to_pddl.py --input_directory 'user_study/fcp/forced_coordination/' \
 --output_directory 'user_study/fcp/forced_coordination/' \
...
#### **Example usage**
```bash
python detect_int_user.py --directory user_study/fcp/counter_circuit/
```
