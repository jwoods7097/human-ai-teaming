...
def init_game_settings_random(algo: str, baselines: list, human_name: str, layouts: list, trial_algo=None,
    ...
    flag = 0
    for algo in ALGO_BASELINES:
        layout_flag = 1
        for layout in layouts:
            algo0 = algo
            algo1 = algo
            human_algo0_pair = [human_name, algo0]
            human_algo1_pair = [algo1, human_name] 
...
def randomize_game_settings():
    ...
    game_settings = init_game_settings_random(ALGO, ALGO_BASELINES, "human", TEST_LAYOUTS, "bc")
    # print(game_settings)
